...
export const coverLetters = {
  ...
  versions: {
    short: {
      ...
      paragraphs: [
        "I am writing to express my strong interest in the UX/UI Designer role. With proven experience shipping 13+ web platforms and 3 mobile applications across fintech, SaaS, and marketing, I specialize in transforming complex user requirements into intuitive, accessible, and high-converting products.",
    ...
    concise: {
      ...
      paragraphs: [
        "I am writing to express my strong interest in the UX/UI Designer role. As a product-focused designer with hands-on experience shipping 13+ responsive web platforms and 3 mobile applications across fintech, SaaS, and marketing domains, I specialize in creating intuitive, accessible, and high-converting user experiences.",
    ...
    comprehensive: {
      ...
      paragraphs: [
        "I am writing to express my strong interest in the UX/UI Designer position. With a proven track record of shipping 13+ responsive web platforms and 3 mobile applications across fintech, SaaS, and digital marketing ecosystems, I specialize in transforming complex user requirements into intuitive, accessible, and conversion-focused digital experiences.",

...
export const coverLetter = {
  ...
  paragraphs: [
    ...
    "Beyond individual features, I take pride in crafting scalable design systems from the ground up. In Figma, I architected comprehensive multi-brand component libraries utilizing Auto Layout, component variants, and design tokens, reducing developer handoff time by 30% while ensuring strict compliance with WCAG 2.1 AA accessibility guidelines. Furthermore, I integrate modern AI-assisted workflows (Cursor AI, Antigravity, Claude) and interactive prototyping tools (Framer, FigJam, Tailwind CSS) to accelerate iteration cycles from low-fidelity wireframes to production-ready interfaces.",

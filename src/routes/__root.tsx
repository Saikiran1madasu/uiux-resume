...
const APP_NAME = "Madasu Sai Kiran — UX/UI Designer";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Corrected, print-ready resume for Madasu Sai Kiran, UX/UI designer specializing in fintech and marketing products.",
      },

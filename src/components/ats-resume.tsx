...
export function AtsResume() {
  ...
  return (
    <div className="space-y-8 sm:space-y-10 print:space-y-0 font-ats">
      {/* PAGE 1 */}
      <article className="resume-page mx-auto flex flex-col justify-between bg-white px-8 py-8 sm:px-11 sm:py-10 text-ink shadow-[0_24px_60px_-24px_rgba(26,35,50,0.28)]">
        <div>
          {/* Header */}
          <header className="text-left border-b-2 border-ink pb-4">
            ...
            <p className="mt-2.5 font-ats text-[13px] leading-normal text-ink">
          ...
          <section className="mt-6">
            ...
            <p className="font-ats text-[13.5px] leading-relaxed text-ink">{resume.summary}</p>
          </section>
              ...
              {resume.experience.map((job) => (
                <div key={job.org}>
                  <div className="flex flex-wrap items-baseline justify-between">
                    <p className="font-ats text-[15px] font-bold text-ink">{job.title}</p>
                    <span className="font-ats text-xs font-semibold text-ink">{job.dates.replace("—", "-")}</span>
                  </div>
                  <p className="font-ats text-[13px] font-semibold text-ink mt-0.5">
                    {job.org} &nbsp;|&nbsp; {job.type}
                  </p>
                  <ul className="mt-2 list-disc pl-5 font-ats text-[13px] leading-relaxed text-ink space-y-1.5">
                    {job.bullets.map((b) => (
                      <li key={b}>{b}</li>
                    ))}
                  </ul>
          ...
          <section className="mt-6">
            ...
            <div className="space-y-3">
              {resume.projects.map((p) => (
                <div key={p.title} className="font-ats text-[13px] leading-relaxed text-ink">
        ...
        {/* Page 1 Footer */}
        <footer className="mt-6 flex items-center justify-between border-t border-ink/40 pt-3 text-xs text-ink">
      ...
      <article className="resume-page mx-auto flex flex-col justify-between bg-white px-8 py-8 sm:px-11 sm:py-10 text-ink shadow-[0_24px_60px_-24px_rgba(26,35,50,0.28)]">
        <div>
          ...
          <section className="mt-6">
            ...
            <ul className="list-disc pl-5 font-ats text-[13px] leading-relaxed text-ink space-y-2">
              <li>
          ...
          <section className="mt-6">
            ...
            <div className="space-y-3 font-ats text-[13px] leading-snug text-ink">
          ...
          <section className="mt-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2.5 font-ats text-[13px] text-ink">
          ...
          <section className="mt-6">
            ...
            <p className="font-ats text-[13px] text-ink">{resume.languages.join("   ·   ")}</p>
          </section>
        </div>
